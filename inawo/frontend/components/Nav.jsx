...
function Nav() {
  return (
    <div>
        ...
        <div className="sm:grid nav-container">
          ...
          <nav className="nav-bar">
            <div className="nav-inner-flex">
              ...
              <div className="lg:flex flex-row gap-4 justify-start items-center w-full hover:font-bold ease-in-out duration-200 icon sm: block">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
            ...
            <div className="flex flex-row gap-4 justify-start items-end w-full hover:font-bold ease-in-out duration-200 icon ">
              <svg
                xmlns="http //www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
      ...
      {/* Mobile view------------------------------------ */}
      <div className="sm:hidden grid grid-cols-5 place-items-center absolute right-0 left-0 bottom-0 w-[100vw] h-[15 vw] gap-4 border-2 px-4 bg-black">
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
